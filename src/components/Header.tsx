...
import { BellIcon, Building2 } from "lucide-react";
...
export default function Header() {
  ...
  return <div className="w-full grid grid-cols-2 gap-4 p-4 border-b">
    ...
    <Avatar>
        <AvatarImage src="https://logo.clearbit.com/twenty.com" />
        <AvatarFallback>Twenty</AvatarFallback>
    </Avatar>
        <h1 className="ml-2 font-bold">Twenty</h1>
    </div>
